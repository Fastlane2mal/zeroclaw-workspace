...
### Gig Scouting
- **Monitor upcoming shows** in Preston, Manchester, Newcastle, Liverpool
...
- Local promoter pages (including Manchester, Newcastle, Preston)
...
### Geographic Focus
**Primary:** Preston, Manchester  
**Secondary:** Liverpool, Newcastle, Leeds  
**Occasional:** Sheffield, Birmingham (for major acts)  
...
- Travel willingness (Preston only vs. happy to go to Manchester)

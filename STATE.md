...
**Current focus:** Platform stable — Bob operational, architecture consolidated
**Status:** Tool calling confirmed working via OpenRouter. Bob is the active persona.
...
- Consolidated architecture documentation into BUILD_ARCHITECTURE.md, including provenance mapping and decision logs.
- Updated related TODO items to reflect completion.

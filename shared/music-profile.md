...
- ## Favourite Genres
  ...
  Examples:
- Americana
- Celtic (Folk, Alternative, Rock)
- Rock (classic, indie, alternative)
- Folk (traditional, contemporary)
- ## Gig Preferences
- ### Venue Types
- [Preferred venues: Intimate clubs? Large arenas? Festivals? Pubs with live music?]
- ### Willing to Travel
- [How far will you travel for gigs?]
	- Newcastle area (15-mile radius)
	- UK-wide for special acts
- ### Preferred Days
- Any day
- ### Budget per Gig
- [Typical spending range]
	- £10-20 (local pub gigs)
	- £20-40 (mid-size venues)
	- £40+ (major arena shows)
- ## Past Memorable Gigs
  Full list from  https://www.setlist.fm/user/fastlane2
-
- **##**** Instruments Owned**
- Various Acoustic Guitars 6 and 12 String
...
- | Artist | Notes |
  ...
  ---
- ## Notes for Ziggy
- Prioritise gigs within travelling distance of South Shields — Newcastle and 
  Sunderland are the nearest major venues, but Malcolm may travel further for 
  the right act
- The artists above are the core watchlist — alert immediately if any are touring
- Expand recommendations to similar artists in the folk/acoustic and rock/indie 
